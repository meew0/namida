            ...
            if status < 0 as libc::c_int {
                ...
                delta = (1000000 as libc::c_longlong
                    * (stop.tv_sec - start.tv_sec) as libc::c_longlong
                    ...
                    - start.tv_usec as libc::c_longlong) as u_int64_t;
...
pub unsafe extern "C" fn process_options(
    ...
    let mut long_options: [option; 12] = [
        {
            let mut init = option {
    ...
    loop {
        ...
        match which {
            ...
            99 => {
                (*parameter).client = optarg;
            }
            102 => {
                (*parameter).finishhook = optarg as *mut libc::c_uchar;
            }
            97 => {
                (*parameter).allhook = optarg as *mut libc::c_uchar;
            }
            98 => {
