...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    extc::fseeko(file, 0 as libc::c_int as extc::__off64_t, 2 as libc::c_int);
    file_size = extc::ftello(file) as u64;
    extc::fseeko(file, 0 as libc::c_int as extc::__off64_t, 0 as libc::c_int);
    while extc::fread(
