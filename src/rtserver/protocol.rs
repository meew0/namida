...
extern "C" {
    ...
    fn start_vsib(session: *mut ttp_session_t);
    ...
    fn parse_evn_filename(filename: *mut libc::c_char) -> *mut evn_filename;
    fn get_aux_entry(
        key: *mut libc::c_char,
        auxinfo: *mut *mut libc::c_char,
        nr_auxinfo: libc::c_int,
    ) -> *mut libc::c_char;
}
...
pub unsafe extern "C" fn ttp_open_transfer(
    ...
    let mut d: timeval = timeval { tv_sec: 0, tv_usec: 0 };
    ...
    if (strrchr(filename.as_mut_ptr(), '/' as i32)).is_null() {
        ef = parse_evn_filename(filename.as_mut_ptr());
        (*param).fileout = 0 as libc::c_int as u_int16_t;
    } else {
        ef = parse_evn_filename(
            (strrchr(filename.as_mut_ptr(), '/' as i32))
                .offset(1 as libc::c_int as isize),
        );
        (*param).fileout = 1 as libc::c_int as u_int16_t;
    }
    if (*ef).valid == 0 {
        fprintf(
            stderr,
            b"Warning: EVN filename parsing failed, '%s' not following EVN File Naming Convention?\n\0"
                as *const u8 as *const libc::c_char,
            filename.as_mut_ptr(),
        );
    }
    if (get_aux_entry(
        b"sl\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        (*ef).auxinfo,
        (*ef).nr_auxinfo,
    ))
        .is_null()
    {
        (*param).totalslots = 1 as libc::c_int;
    } else {
        sscanf(
            get_aux_entry(
                b"sl\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
            ...
            &mut (*param).totalslots as *mut libc::c_int,
        );
    }
    if (get_aux_entry(
        b"sn\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        (*ef).auxinfo,
        (*ef).nr_auxinfo,
    ))
        .is_null()
    {
        (*param).slotnumber = 1 as libc::c_int;
    } else {
        sscanf(
            get_aux_entry(
                b"sn\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
            ...
            b"%d\0" as *const u8 as *const libc::c_char,
            &mut (*param).slotnumber as *mut libc::c_int,
        );
    }
    if (get_aux_entry(
        ...
        .is_null()
    {
        (*param).samplerate = 512 as libc::c_int;
    } else {
        sscanf(
            get_aux_entry(
                b"sr\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
            ...
            b"%d\0" as *const u8 as *const libc::c_char,
            &mut (*param).samplerate as *mut libc::c_int,
        );
    }
    (*xfer)
        .vsib = fopen(
        b"/dev/vsib\0" as *const u8 as *const libc::c_char,
        b"r\0" as *const u8 as *const libc::c_char,
    );
    if ((*xfer).vsib).is_null() {
        sprintf(
            g_error.as_mut_ptr(),
            b"VSIB board does not exist in /dev/vsib or it cannot be read\0" as *const u8
                as *const libc::c_char,
        );
        status = full_write(
            (*session).client_fd,
            b"\x02\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            1 as libc::c_int as size_t,
        ) as libc::c_int;
        if status < 0 as libc::c_int {
            error_handler(
    ...
    if (*param).fileout != 0 {
        ...
        if ((*xfer).file).is_null() {
            sprintf(
                g_error.as_mut_ptr(),
                b"Could not open local file '%s' for writing\0" as *const u8
                    as *const libc::c_char,
                filename.as_mut_ptr(),
            );
            status = full_write(
                (*session).client_fd,
                b"\x10\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            ) as libc::c_int;
            if status < 0 as libc::c_int {
                error_handler(
    ...
    if !(((*ef).data_start_time_ascii).is_null() || (*ef).data_start_time <= 1.0f64) {
        let mut timedelta_usec: u_int64_t = 0;
        starttime = (*ef).data_start_time - 0.5f64;
        if gettimeofday(&mut d, 0 as *mut libc::c_void) == 0 as libc::c_int {} else {
            __assert_fail(
                b"gettimeofday(&d, NULL) == 0\0" as *const u8 as *const libc::c_char,
                b"protocol.c\0" as *const u8 as *const libc::c_char,
                506 as libc::c_int as libc::c_uint,
                (*::core::mem::transmute::<
                    &[u8; 39],
                    &[libc::c_char; 39],
                >(b"int ttp_open_transfer(ttp_session_t *)\0"))
                    .as_ptr(),
            );
        }
        'c_10600: {
        ...
        timedelta_usec = (((starttime - d.tv_sec as libc::c_double) * 1000000.0f64)
            as libc::c_ulong as libc::c_double - d.tv_usec as libc::c_double)
            as u_int64_t;
        fprintf(
            stderr,
            b"Sleeping until specified time (%s) for %Lu usec...\n\0" as *const u8
                as *const libc::c_char,
            (*ef).data_start_time_ascii,
            timedelta_usec as ull_t,
        );
    ...
    if !(get_aux_entry(
        b"flen\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        (*ef).auxinfo,
        (*ef).nr_auxinfo,
    ))
        .is_null()
    {
        sscanf(
            ...
            b"%lu\0" as *const u8 as *const libc::c_char,
            &mut (*param).file_size as *mut u_int64_t,
        );
    } else if !(get_aux_entry(
        b"dl\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        (*ef).auxinfo,
        (*ef).nr_auxinfo,
    ))
        .is_null()
    {
        ...
        i = 0 as libc::c_int as u_int16_t;
        while (i as libc::c_int) < (*ef).nr_auxinfo && found == 0 {
            if strncmp(
                *((*ef).auxinfo).offset(i as isize),
                ...
                ) == 0
            {
                ...
                *((*ef).auxinfo).offset(i as isize),
                b"flen\0" as *const u8 as *const libc::c_char,
        ...
        if found == 0 {
            (*param)
                .file_size = (60 as libc::c_longlong * 512000000 as libc::c_longlong
                * 4 as libc::c_longlong / 8 as libc::c_int as libc::c_longlong)
                as u_int64_t;
        }
    }
    fprintf(
        stderr,
        b"Realtime file length in bytes: %Lu\n\0" as *const u8 as *const libc::c_char,
